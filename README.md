...
- `reasoningEffort` (optional): OpenAI reasoning effort setting (default: `low`). Options: `minimal` (10 seconds to response; poor quality), `low` (30s), `medium` (60s), `high` (???; errors).
